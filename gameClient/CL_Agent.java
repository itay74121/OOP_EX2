...
//	private long _key;
	...
	private PriorityQueue<CL_Pokemon> PQpokemons;
    ...
    public void signalStop(CL_Pokemon pokemon)
	{
	...
	public void updatePqueue(String pokemons)
	{
		ArrayList<CL_Pokemon> arr = Arena.json2Pokemons(pokemons);
		if (this.PQpokemons==null)
		{
			this.PQpokemons = new PriorityQueue<CL_Pokemon>(this.commander);
		}
		this.PQpokemons.clear();
		for (CL_Pokemon pokemon:arr)
		{
			this.PQpokemons.add(pokemon);
		}
	}
}
